...
<body>
  ...
  <div class="mx-auto col-md-6 col-sm-12">
    ...
    <form name="register" action="./register.php" method="POST">
      ...
      <div class="form-group">
        <input type="password" name ="passwordCheck" class="form-control" id="InputPasswordCheck" placeholder="confirm password">
        <small id="InputPasswordCheck" class="form-text text-danger">確認用パスワード
        </small>
      </div>
