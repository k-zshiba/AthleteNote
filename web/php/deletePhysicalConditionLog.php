...
<body>
  ...
  <?php
    if ($result) {
        echo '削除に成功しました。<br>'.'<button type="button" class="btn btn-danger" onclick="location.href = \'./watchPCLog.php\'">体調ログ一覧に戻る</button>';
    }else {
        echo '削除に失敗しました。<br>'.'<button type="button" class="btn btn-danger" onclick="location.href = \'./watchPCLog.php\'">体調ログ一覧に戻る</button>';
    }
  ?>
  </div>
</html>
