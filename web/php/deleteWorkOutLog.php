...
<body>
  ...
  <?php
    if ($result_for_delete_workout_log && $result_for_delete_contents) {
        echo '削除に成功しました。<br>'.'<button type="button" class="btn btn-danger" onclick="location.href = \'./watchWorkOutLog.php\'">練習記録一覧に戻る</button>';
    }else {
        echo '削除に失敗しました。<br>'.'<button type="button" class="btn btn-danger" onclick="location.href = \'./watchWorkOutLog.php\'">練習記録一覧に戻る</button>';
    }
  ?>
  </div>
</html>
